...
public class TimerHandler {
    ...
    public TimerHandler(Plugin pluginn) {
        //set plugin
        plugin = pluginn;
    }
    /**
    ...
    * newTimer
    */
    public static TimerHandler startTimer(Plugin pluginn, long startTimee, long endTimee, Runnable actionn) {
        //create timer
        TimerHandler timer = new TimerHandler(pluginn);
